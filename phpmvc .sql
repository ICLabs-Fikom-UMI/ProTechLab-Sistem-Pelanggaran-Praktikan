...
CREATE TABLE `mst_user` (
  ...
  `password` enum('admin123','asisten123','praktikan123','') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `mst_user` (`id_user`, `nama`, `nim`, `username`, `role`, `password`) VALUES
(1, 'Naufal', '13020210205', 'nofal', 'asisten', 'asisten123');
...
INSERT INTO `pakaian` (`id`, `nama`, `deskripsi`) VALUES
(2, 'Laki-Laki', '- tidak boleh berambut panjang dan rambut rapi\r\n- memakai pakaian kemeja putih , celana kain hitam polos\r\n'),
(21, 'Perempuan', '-memakai pakaian tunik putih\r\n-jilbab segitiga hitam\r\n-kaos kaki panjang diatas mata kaki\r\n');
