          ...
          <div class="navbar-nav ms-auto">
            ...
            <div class="dropdown  ">
              ...
              <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdownMenuAvatar">
                <li>
                  <a class="dropdown-item" href="<?= BASEURL; ?>/profile"><i class="bi bi-person-circle"></i> My
                    profile</a>
                </li>
        ...
        <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-dark">
          <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
            ...
            <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
              ...
              <li>
                <a href="#submenu1" data-bs-toggle="collapse" class="nav-link px-0 text-white align-middle">
                  <i class="fs-4 bi-speedometer2"></i> <span class="ms-1 d-none d-sm-inline">Fitur</span> </a>
                <ul class="collapse show nav flex-column ms-1" id="submenu1" data-bs-parent="#menu">

                <?php if ($_SESSION['role'] == 'asisten' || $_SESSION['role'] == 'admin') { ?>
                  <li class="w-100">
                    <a  href="<?= BASEURL; ?>/menu/index/" class="nav-link px-0 text-white" data-bs-toggle="modal" data-bs-target="#formModal"> <span
                        class="d-none d-sm-inline">Lapor</span></a>
                  </li>
                <?php } ?>
              ...
              <li>
                <a href="<?= BASEURL; ?>/tatib" class="nav-link px-0 text-white align-middle">
                  <i class="fs-4 bi-table"></i> <span class="ms-1 d-none d-sm-inline">Peraturan</span></a>
              </li>
              ...
              <li>
                <a href="<?= BASEURL; ?>/pakaian" class="nav-link px-0 text-white align-middle">
                  <i class="fs-4 bi-table"></i> <span class="ms-1 d-none d-sm-inline">Pakaian</span></a>
              </li>
              ...
              <li>
                <a href="#submenu3" data-bs-toggle="collapse" class="nav-link px-0 text-white align-middle">
