$(function () {
    ...
    $(".tombolTambahLaporan").on("click", function () {
        $("#judulmodal").html("Tambah Laporan");
        $(".modal-body button[type=submit]").html("Tambah Data");
    });
    
    $(".tampilEdit").on("click", function () {
        $("#judulmodal").html("Edit Laporan"); // Mengubah teks judul menjadi "Edit Laporan"
        $(".modal-body button[type=submit]").html("Simpan Perubahan"); // Mengubah teks tombol menjadi "Simpan Perubahan"
        $(".modal-body form").attr("action", 'http://localhost/ProTechLab-Sistem-Pelanggaran-Praktikan/public/menu/ubah');
